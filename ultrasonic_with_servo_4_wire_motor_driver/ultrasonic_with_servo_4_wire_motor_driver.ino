...
/*This code demos a 4 wire mode of driving, it does not have any type of speed control, so it
runs at full speed. From what I can tell the servo is always moving and getting information about 
what is around the robot. - LeRoy
*/
...
//the PWM of Center, the PWM of LEFT 45 degrees, and the PWM of Right 45 degrees for your servo - LeRoy
